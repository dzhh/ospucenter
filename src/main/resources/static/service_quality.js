...
/***/ function(module, exports, __webpack_require__) {
	...
	var SERVICES = [{ serviceName: 'IP地址', useTimes: '1234', successRate: '100%', meanResponseTime: '66ms' }, { serviceName: '快递查询', useTimes: '3432423', successRate: '0%', meanResponseTime: '990ms' }, { serviceName: '违章查询', useTimes: '423423', successRate: '120%', meanResponseTime: '0ms' }, { serviceName: 'IP地址', useTimes: '6546', successRate: '34%', meanResponseTime: '23410ms' }, { serviceName: 'IP地址', useTimes: '23', successRate: '77%', meanResponseTime: '41ms' }, { serviceName: 'IP地址', useTimes: '0', successRate: '1%', meanResponseTime: '520ms' }, { serviceName: 'IP地址', useTimes: '2345', successRate: '9%', meanResponseTime: '10ms' }];
	
	var service_quality = (_dec = (0, _reactRedux.connect)(function (state, props) {
	    return {
	        config: state.config
	    };
	}, function (dispatch) {
	    ...
	    (0, _inherits3.default)(service_quality, _Component);
	
	    function service_quality(props) {
	        (0, _classCallCheck3.default)(this, service_quality);
	
	        var _this = (0, _possibleConstructorReturn3.default)(this, (service_quality.__proto__ || (0, _getPrototypeOf2.default)(service_quality)).call(this, props));
	    ...
	    (0, _createClass3.default)(service_quality, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    _card2.default,
	                    { title: '\u670D\u52A1\u8D28\u91CF', className: 'cardStyle' },
