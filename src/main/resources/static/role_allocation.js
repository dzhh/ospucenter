...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.clearRoleByUserIds = exports.addRolesUser = exports.selectRolesByUserId = exports.allocationLists = exports.deletePermission = exports.permissionList = exports.testPer = exports.addRole = exports.deleteRole = exports.roleList = exports.selectRoleByUserId = undefined;
	
	var _utils = __webpack_require__(119);
	
	var _ajax = __webpack_require__(184);
	
	var ajaxFun = _interopRequireWildcard(_ajax);
	...
	var selectRoleByUserId = exports.selectRoleByUserId = (0, _utils.createAjaxAction)(ajaxFun.fetchJSONByPost('/userRole/selectRoleByUserId'));
	//角色列表
	var roleList = exports.roleList = (0, _utils.createAjaxAction)(ajaxFun.fetchJSONByPost('/role/roleLists'));
	
	var deleteRole = exports.deleteRole = (0, _utils.createAjaxAction)(ajaxFun.fetchJSONByPost('/role/deleteRole'));
	
	var addRole = exports.addRole = (0, _utils.createAjaxAction)(ajaxFun.fetchJSONByPost('/role/addRole'));
	
	var testPer = exports.testPer = (0, _utils.createAjaxAction)(ajaxFun.fetchJSONByPost('/permission/deleteMenu'));
	
	var permissionList = exports.permissionList = (0, _utils.createAjaxAction)(ajaxFun.fetchJSONByPost('/permission/permissionLists'));
	
	var deletePermission = exports.deletePermission = (0, _utils.createAjaxAction)(ajaxFun.fetchJSONByPost('/permission/deletePermission'));
	
	var allocationLists = exports.allocationLists = (0, _utils.createAjaxAction)(ajaxFun.fetchJSONByPost('/userRole/allocationLists'));
	var selectRolesByUserId = exports.selectRolesByUserId = (0, _utils.createAjaxAction)(ajaxFun.fetchJSONByPost('/userRole/selectRoleByUserId'));
	
	var addRolesUser = exports.addRolesUser = (0, _utils.createAjaxAction)(ajaxFun.fetchJSONByPost('/userRole/addRole2User'));
	
	var clearRoleByUserIds = exports.clearRoleByUserIds = (0, _utils.createAjaxAction)(ajaxFun.fetchJSONByPost('/userRole/clearRoleByUserIds'));
	
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("D:\\project\\WebstormProjects\\APIStore\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "userRole.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _userRole = __webpack_require__(212);
	...
	var role_allocation = (_dec = (0, _reactRedux.connect)(function (state, props) {
	    return {
	        config: state.config,
	        logout: state.logout
	    };
	    ...
	    (0, _inherits3.default)(role_allocation, _Component);
	
	    function role_allocation(props) {
	        (0, _classCallCheck3.default)(this, role_allocation);
	
	        var _this = (0, _possibleConstructorReturn3.default)(this, (role_allocation.__proto__ || (0, _getPrototypeOf2.default)(role_allocation)).call(this, props));
	        ...
	        _this.showModal = function (record) {
	            ...
	            user.pageNo = 1;
	            user.pageSize = 10000;
	            (0, _userRole.selectRolesByUserId)(user, function (res) {
	                console.log("++++++" + res);
	                if (res.ospState == 200) {
	                    res.data.defaultValue = res.data.defaultValue.split(',');
	                    res.data.allRoleIds = res.data.allRoleIds.split(',');
	                    _this.setState({ checkedList: res.data.defaultValue, options: res.data.ucRole,
	        ...
	        _this.handleOk = function () {
	            console.log("选中的角色id为" + _this.state.checkedList);
	            var user = {};
	            user.id = _this.state.selectId;
	            user.ids = _this.state.checkedList.toString();
	            (0, _userRole.addRolesUser)(user, function (res) {
	                console.log("++++++" + res);
	                if (res.ospState == 200) {
	        ...
	        _this.handleCancel = function () {
	            _this.setState({ visible: false, checkedList: [],
	                defaultId: [] });
	        };
	        ...
	        _this.onSelectChange = function (selectedRowKeys, selectedRows) {
	            ...
	            _this.setState({ deleteIds: ids });
	        };
	
	        _this.onDelete = function () {
	            if (_this.state.selectedRowKeys == '') {
	                _message2.default.error('请选择要清空的用户角色');
	            } else {
	                _this.setState({ loading: true });
	                var user = {};
	                user.ids = _this.state.deleteIds.toString();
	                (0, _userRole.clearRoleByUserIds)(user, function (res) {
	                    console.log("++++++" + res);
	                    if (res.ospState == 200) {
	        ...
	        _this.checkOnChange = function (checkedList) {
	            console.log('每次改变的值 ', checkedList);
	            _this.setState({
	                checkedList: checkedList,
	                indeterminate: !!checkedList.length && checkedList.length < _this.state.plainOptions.length,
	                checkAll: checkedList.length === _this.state.plainOptions.length
	            });
	        };
	        ...
	        _this.onCheckAllChange = function (e) {
	            _this.setState({
	                checkedList: e.target.checked ? _this.state.plainOptions : [],
	                indeterminate: false,
	    ...
	    (0, _createClass3.default)(role_allocation, [{
	        ...
	        value: function componentWillMount() {
	            ...
	            (0, _userRole.allocationLists)(pagination, function (res) {
	                console.log("++++++" + res);
	                if (res.ospState == 200) {
	                    _this2.setState({ data: res.data.ucUserRole, staticData: res.data.ucUserRole });
	                    console.log(res);
	                } else if (res.ospState == 401) {
	                    _message2.default.warning("没有登录或登录时间过期，请重新登录", 2, function () {
	                        _reactRouter.hashHistory.push('/login');
	        ...
	        value: function render() {
	            ...
	            var columns = [{
	                ...
	                dataIndex: 'operation',
	                render: function render(text, record, index) {
	                    return _this3.state.data.length > 1 ? _react2.default.createElement(
	                        'a',
	                        { onClick: function onClick() {
	                                return _this3.showModal(record);
	                            } },
	                        '\u9009\u62E9\u89D2\u8272'
	                    ) : null;
	                }
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    _card2.default,
	                    { title: '\u89D2\u8272\u5206\u914D', className: 'cardStyle' },
	                    _react2.default.createElement(
	                        'div',
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            { style: { width: '60%' },
	                                ...
	                                footer: [_react2.default.createElement(
	                                    _button2.default,
	                                    { key: 'back', size: 'large', onClick: this.handleCancel },
	                                    '\u53D6\u6D88'
	                                ), _react2.default.createElement(
	                                    _button2.default,
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    'div',
	                                    { style: { width: '25%' } },
	                                    _react2.default.createElement(CheckboxGroup, { options: this.state.options, value: this.state.checkedList, onChange: this.checkOnChange })
	                                )
	                            )
	                        )
	                    ),
	...
	exports.default = role_allocation;
	
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("D:\\project\\WebstormProjects\\APIStore\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "role_allocation.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }

/***/ }

});
//# sourceMappingURL=role_allocation.js.map