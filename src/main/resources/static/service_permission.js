...
/***/ function(module, exports, __webpack_require__) {
	...
	var SERVICES = [{ serviceName: 'IP地址', user: '用户a', servicePackage: '套餐一', serviceRemainingTiems: '1234', peakValue: '66秒/次' }, { serviceName: 'IP地址', user: '用户b', servicePackage: '套餐三', serviceRemainingTiems: '2222', peakValue: '990秒/次' }, { serviceName: 'IP地址', user: '用户c', servicePackage: '套餐五', serviceRemainingTiems: '22', peakValue: '0秒/次' }, { serviceName: 'IP地址', user: '用户d', servicePackage: '套餐二', serviceRemainingTiems: '10000', peakValue: '23410秒/次' }, { serviceName: 'IP地址', user: '用户e', servicePackage: '套餐一', serviceRemainingTiems: '6666', peakValue: '41秒/次' }, { serviceName: 'IP地址', user: '用户f', servicePackage: '套餐八', serviceRemainingTiems: '0', peakValue: '520秒/次' }, { serviceName: 'IP地址', user: '用户g', servicePackage: '套餐一', serviceRemainingTiems: '123', peakValue: '10秒/次' }];
	
	var service_permission = (_dec = (0, _reactRedux.connect)(function (state, props) {
	    return {
	        config: state.config
	    };
	}, function (dispatch) {
	    ...
	    (0, _inherits3.default)(service_permission, _Component);
	
	    function service_permission(props) {
	        (0, _classCallCheck3.default)(this, service_permission);
	
	        var _this = (0, _possibleConstructorReturn3.default)(this, (service_permission.__proto__ || (0, _getPrototypeOf2.default)(service_permission)).call(this, props));
	    ...
	    (0, _createClass3.default)(service_permission, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    _card2.default,
	                    { title: '\u670D\u52A1\u6743\u9650', className: 'cardStyle' },
	...
	exports.default = service_permission;
	
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("D:\\project\\WebstormProjects\\APIStore\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "service_permission.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }

/***/ }

});
//# sourceMappingURL=service_permission.js.map