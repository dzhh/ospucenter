...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.clearPermissionByRoleIds = exports.addPermission2Role = exports.selectPermissionByRoleId = exports.rolePermissionAllocation = undefined;
	 ...
	 */
	var rolePermissionAllocation = exports.rolePermissionAllocation = (0, _utils.createAjaxAction)(ajaxFun.fetchJSONByPost('/rolePermission/rolePermissionAllocation'));
	
	var selectPermissionByRoleId = exports.selectPermissionByRoleId = (0, _utils.createAjaxAction)(ajaxFun.fetchJSONByPost('/rolePermission/selectPermissionByRoleId'));
	var addPermission2Role = exports.addPermission2Role = (0, _utils.createAjaxAction)(ajaxFun.fetchJSONByPost('/rolePermission/addPermission2Role'));
	
	var clearPermissionByRoleIds = exports.clearPermissionByRoleIds = (0, _utils.createAjaxAction)(ajaxFun.fetchJSONByPost('/rolePermission/clearPermissionByRoleIds'));
	
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("D:\\project\\WebstormProjects\\APIStore\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "rolePermission.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _rolePermission = __webpack_require__(1129);
	...
	var permission_allocation = (_dec = (0, _reactRedux.connect)(function (state, props) {
	    return {
	        config: state.config,
	        logout: state.logout
	    };
	    ...
	    (0, _inherits3.default)(permission_allocation, _Component);
	
	    function permission_allocation(props) {
	        (0, _classCallCheck3.default)(this, permission_allocation);
	
	        var _this = (0, _possibleConstructorReturn3.default)(this, (permission_allocation.__proto__ || (0, _getPrototypeOf2.default)(permission_allocation)).call(this, props));
	
	        _this.showModal = function (record) {
	            var user = {};
	            user.id = record.roleId;
	            (0, _rolePermission.selectPermissionByRoleId)(user, function (res) {
	                console.log("++++++" + res);
	                if (res.ospState == 200) {
	                    ...
	                    _this.setState({ checkedList: res.data.defaultValue, options: res.data.permissionLists,
	        ...
	        _this.handleOk = function () {
	            ...
	            (0, _rolePermission.addPermission2Role)(user, function (res) {
	                console.log("++++++" + res);
	                if (res.ospState == 200) {
	        ...
	        _this.onDelete = function () {
	            if (_this.state.selectedRowKeys == '') {
	                _message2.default.error('请选择要清空权限的角色');
	            } else {
	                _this.setState({ loading: true });
	                var user = {};
	                user.ids = _this.state.deleteIds.toString();
	                (0, _rolePermission.clearPermissionByRoleIds)(user, function (res) {
	                    console.log("++++++" + res);
	                    if (res.ospState == 200) {
	    ...
	    (0, _createClass3.default)(permission_allocation, [{
	        key: 'componentWillMount',
	        value: function componentWillMount() {
	            var _this2 = this;
	
	            (0, _rolePermission.rolePermissionAllocation)('', function (res) {
	                console.log("++++++" + res);
	                if (res.ospState == 200) {
	                    _this2.setState({ data: res.data.rolePermission, staticData: res.data.rolePermission });
	                    console.log(res);
	                } else if (res.ospState == 401) {
	                    _message2.default.warning("没有登录或登录时间过期，请重新登录", 2, function () {
	                        _reactRouter.hashHistory.push('/login');
	        ...
	        value: function render() {
	            ...
	            var columns = [{
	                ...
	                render: function render(text, record, index) {
	                    return _this3.state.data.length > 0 ? _react2.default.createElement(
	                        'a',
	                        { onClick: function onClick() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    _card2.default,
	                    { title: '\u6743\u9650\u5206\u914D', className: 'cardStyle' },
	                    _react2.default.createElement(
	                        'div',
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    'div',
	                                    { style: { width: '25%' } },
	                                    _react2.default.createElement(CheckboxGroup, { options: this.state.options, value: this.state.checkedList, onChange: this.onChange })
	                                )
	                            )
	                        )
	                    ),
	    ...
	    return permission_allocation;
	}(_react.Component)) || _class) || _class);
	exports.default = permission_allocation;
	
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("D:\\project\\WebstormProjects\\APIStore\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "permission_allocation.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }

/***/ }

});
//# sourceMappingURL=permission_allocation.js.map