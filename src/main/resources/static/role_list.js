...
/***/ function(module, exports, __webpack_require__) {
	...
	var role_list = (_dec = (0, _reactRedux.connect)(function (state, props) {
	    return {
	        config: state.config,
	        logout: state.logout
	    };
	    ...
	    (0, _inherits3.default)(role_list, _Component);
	
	    function role_list(props) {
	        (0, _classCallCheck3.default)(this, role_list);
	
	        var _this = (0, _possibleConstructorReturn3.default)(this, (role_list.__proto__ || (0, _getPrototypeOf2.default)(role_list)).call(this, props));
	
	        _this.deleteIds = function (ids) {
	            var pagination = {};
	            pagination.pageNo = 1;
	            pagination.pageSize = 100000;
	            pagination.ids = ids.toString();
	            (0, _userRole.deleteRole)(pagination, function (res) {
	                //1  有效 0 禁止
	                console.log("++++++" + res);
	                if (res.ospState == 200) {
	                    ...
	                    _this.setState({ data: res.data.ucRole, staticData: res.data.ucRole });
	                    console.log(res);
	        ...
	        _this.handleOk = function () {
	            _this.props.form.validateFields(function (err, values) {
	                if (!err) {
	                    ...
	                    (0, _userRole.addRole)(role, function (res) {
	                        //1  有效 0 禁止
	                        console.log("++++++" + res);
	                        if (res.ospState == 200) {
	                            _this.setState({ loading: true });
	                            ...
	                            _message2.default.warning(res.msg + res.data.UcRole);
	                        }
	                    });
	                }
	            });
	        ...
	        _this.deleteRole = function (index) {
	            var ids = [];
	            ids.push(index);
	            _this.deleteIds(ids);
	        };
	        ...
	        _this.onDelete = function () {
	            if (_this.state.selectedRowKeys == '') {
	                _message2.default.error('请选择要删除的角色');
	            } else {
	                _this.deleteIds(_this.state.deleteIds);
	            }
	        };
	        ...
	        _this.onSearch = function () {
	            ...
	            _this.setState({
	                ...
	                data: _this.state.staticData.map(function (record) {
	                    var match = record.roleName.match(reg);
	                    ...
	                    return (0, _extends3.default)({}, record, {
	                        name: _react2.default.createElement(
	                            'span',
	                            null,
	                            record.roleName.split(reg).map(function (text, i) {
	    ...
	    (0, _createClass3.default)(role_list, [{
	        ...
	        value: function componentWillMount() {
	            ...
	            pagination.pageNo = 1;
	            pagination.pageSize = 100000;
	            (0, _userRole.roleList)(pagination, function (res) {
	                //1  有效 0 禁止
	                console.log("++++++" + res);
	                if (res.ospState == 200) {
	
	                    _this2.setState({ data: res.data.ucRole, staticData: res.data.ucRole });
	                    console.log(res);
	                } else {
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    _card2.default,
	                    { title: '\u6743\u9650\u5217\u8868', className: 'cardStyle' },
	                    _react2.default.createElement(
	                        'div',
	                        ...
	                        _react2.default.createElement(
	                            _button2.default,
	                            { type: 'primary', onClick: this.showModal, style: { marginLeft: "10px" } },
	                            '\u6DFB\u52A0'
	                        ),
	                        _react2.default.createElement(
	                            _button2.default,
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    ...
	                                    })(_react2.default.createElement(_input2.default, { placeholder: '\u8BF7\u8F93\u5165\u89D2\u8272\u540D\u79F0!' }))
	                                ),
	                                _react2.default.createElement(
	                                    FormItem,
	                                    { label: '\u89D2\u8272\u7C7B\u578B' },
	                                    getFieldDecorator('systemcode', {
	                                        rules: [{ required: true, message: '请输入角色类型!' }, { pattern: "[A-Za-z0-9]{6}", message: '角色类型为[字母+数字]6位！' }]
	
	                                    })(_react2.default.createElement(_input2.default, { placeholder: '\u8BF7\u8F93\u5165\u89D2\u8272\u7C7B\u578B[\u5B57\u6BCD+\u6570\u5B57]6\u4F4D' }))
	                                )
	                            )
	                        )
	                    ),
	...
	exports.default = role_list;
	
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("D:\\project\\WebstormProjects\\APIStore\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "role_list.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
