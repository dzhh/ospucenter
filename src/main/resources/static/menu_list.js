...
/***/ function(module, exports, __webpack_require__) {
	...
	var menu_list = (_dec = (0, _reactRedux.connect)(function (state, props) {
	    return {
	        config: state.config
	    };
	    ...
	    (0, _inherits3.default)(menu_list, _Component);
	
	    function menu_list(props) {
	        (0, _classCallCheck3.default)(this, menu_list);
	
	        var _this = (0, _possibleConstructorReturn3.default)(this, (menu_list.__proto__ || (0, _getPrototypeOf2.default)(menu_list)).call(this, props));
	        ...
	        _this.handleOk = function () {
	            _this.props.form.validateFields(function (err, values) {
	                ...
	                _this.props.config.DATA.push(values);
	                _this.setState({ data: _this.props.config.DATA });
	        ...
	        _this.onDelete = function () {
	            if (_this.state.selectedRowKeys == '') {
	                _message2.default.error('请选择要删除的菜单');
	            } else {
	
	                _this.setState({ loading: true });
	                // ajax request after empty completing
	                setTimeout(function () {
	                    console.log('删除的IDs: ', _this.state.selectedRowKeys);
	        ...
	        _this.onSearch = function () {
	            ...
	            _this.setState({
	                ...
	                data: _this.props.config.DATA.map(function (record) {
	    ...
	    (0, _createClass3.default)(menu_list, [{
	...
	exports.default = menu_list;
	
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("D:\\project\\WebstormProjects\\APIStore\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "menu_list.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
