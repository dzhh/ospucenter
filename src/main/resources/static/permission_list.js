...
/***/ function(module, exports, __webpack_require__) {
	...
	var permission_list = (_dec = (0, _reactRedux.connect)(function (state, props) {
	    return {
	        config: state.config,
	        logout: state.logout
	    };
	    ...
	    (0, _inherits3.default)(permission_list, _Component);
	
	    function permission_list(props) {
	        (0, _classCallCheck3.default)(this, permission_list);
	
	        var _this = (0, _possibleConstructorReturn3.default)(this, (permission_list.__proto__ || (0, _getPrototypeOf2.default)(permission_list)).call(this, props));
	        ...
	        _this.deleteIds = function (ids) {
	            ...
	            (0, _userRole.deletePermission)(pagination, function (res) {
	                //1  有效 0 禁止
	                console.log("++++++" + res);
	                if (res.ospState == 200) {
	                    ...
	                    _this.setState({ data: res.data.permissionList, staticData: res.data.permissionList });
	                } else {
	        ...
	        _this.deletePermission = function (index) {
	            var ids = [];
	            ids.push(index);
	            _this.deleteIds(ids);
	        };
	        ...
	        _this.onSelectChange = function (selectedRowKeys, selectedRows) {
	            ...
	            console.log("menuId===" + _this.state.deleteIds);
	        };
	        ...
	        _this.onSearch = function () {
	            ...
	            _this.setState({
	                ...
	                data: _this.state.staticData.map(function (record) {
	                    var match = record.label.match(reg);
	                    ...
	                    return (0, _extends3.default)({}, record, {
	                        name: _react2.default.createElement(
	                            'span',
	                            null,
	                            record.label.split(reg).map(function (text, i) {
	    ...
	    (0, _createClass3.default)(permission_list, [{
	        key: 'componentWillMount',
	        value: function componentWillMount() {
	            var _this2 = this;
	
	            (0, _userRole.permissionList)('', function (res) {
	                console.log("++++++" + res);
	                var i = 0;
	                if (res.ospState == 200) {
	                    res.data.permissionLists.map(function (item) {
	                        item.key = i++;
	                    });
	                    _this2.setState({ data: res.data.permissionLists,
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    ...
	                                    })(_react2.default.createElement(_input2.default, { placeholder: '\u8BF7\u8F93\u5165\u6743\u9650\u540D\u79F0!' }))
	                                ),
	                                _react2.default.createElement(
	                                    FormItem,
	                                    { label: '\u6743\u9650url' },
	                                    ...
	                                    })(_react2.default.createElement(_input2.default, { placeholder: '\u8BF7\u8F93\u5165\u6743\u9650url' }))
	                                )
	                            )
	                        )
	                    ),
	...
	exports.default = permission_list;
	
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("D:\\project\\WebstormProjects\\APIStore\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "permission_list.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }

/***/ }

});
//# sourceMappingURL=permission_list.js.map