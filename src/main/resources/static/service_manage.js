...
/***/ function(module, exports, __webpack_require__) {
	...
	var SERVICES = [{ serviceName: 'IP地址', interfaceAddress: 'www.baidu.com', serviceProvider: '服务商A', status: '0' }, { serviceName: 'IP地址', interfaceAddress: 'www.baidu.com', serviceProvider: '服务商B', status: '2' }, { serviceName: 'IP地址', interfaceAddress: 'www.baidu.com', serviceProvider: '服务商C', status: '2' }, { serviceName: 'IP地址', interfaceAddress: 'www.baidu.com', serviceProvider: '服务商D', status: '1' }, { serviceName: 'IP地址', interfaceAddress: 'www.baidu.com', serviceProvider: '服务商E', status: '2' }, { serviceName: 'IP地址', interfaceAddress: 'www.baidu.com', serviceProvider: '服务商F', status: '3' }, { serviceName: 'IP地址', interfaceAddress: 'www.baidu.com', serviceProvider: '服务商G', status: '3' }];
	var STATUS = [{ id: '0', value: '下架' }, { id: '1', value: '上架' }, { id: '2', value: '停止' }, { id: '3', value: '启动' }];
	var FormItem = _form2.default.Item;
	var Option = _select2.default.Option;
	var service_manage = (_dec = (0, _reactRedux.connect)(function (state, props) {
	    return {
	        config: state.config
	    };
	}, function (dispatch) {
	    ...
	    (0, _inherits3.default)(service_manage, _Component);
	
	    function service_manage(props) {
	        (0, _classCallCheck3.default)(this, service_manage);
	
	        var _this = (0, _possibleConstructorReturn3.default)(this, (service_manage.__proto__ || (0, _getPrototypeOf2.default)(service_manage)).call(this, props));
	    ...
	    (0, _createClass3.default)(service_manage, [{
	        ...
	        key: 'handleChange',
	        value: function handleChange(record, value) {
	        ...
	        value: function render() {
	            ...
	            var columns = [{
	                ...
	                render: function render(text, record, index) {
	                    ...
	                    return _this2.state.data.length > 0 ? _react2.default.createElement(
	                        'div',
	                        null,
	                        _react2.default.createElement(
	                            _select2.default,
	                            { size: 'large', defaultValue: record.status, style: { width: '80%' }, onChange: _this2.handleChange.bind(null, record) },
	                            _this2.state.status.map(function (item) {
	                                return _react2.default.createElement(
	                                    Option,
	                                    { value: item.id },
	                                    item.value
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    _card2.default,
	                    { title: '\u670D\u52A1\u7BA1\u7406', className: 'cardStyle' },
	                    _react2.default.createElement(_table2.default, { bordered: true, columns: columns, dataSource: this.state.data, pagination: { pageSize: 8 } })
	                )
	            );
	        }
	    }]);
	...
	exports.default = service_manage;
	
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("D:\\project\\WebstormProjects\\APIStore\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "service_manage.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }

/***/ }

});
//# sourceMappingURL=service_manage.js.map