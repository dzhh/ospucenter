...
/***/ function(module, exports, __webpack_require__) {
	...
	var online_user = (_dec = (0, _reactRedux.connect)(function (state, props) {
	    return {
	        config: state.config,
	        logout: state.logout
	    };
	    ...
	    (0, _inherits3.default)(online_user, _Component);
	
	    function online_user(props) {
	        (0, _classCallCheck3.default)(this, online_user);
	
	        var _this = (0, _possibleConstructorReturn3.default)(this, (online_user.__proto__ || (0, _getPrototypeOf2.default)(online_user)).call(this, props));
	        ...
	        _this.handleCancel = function () {
	            _this.setState({ visible: false, auser: {} });
	        };
	
	        _this.deleteLogin = function (index) {
	            var data = {};
	            data.ospToken = index;
	            data.pageNo = 1;
	            data.pageSize = 100000;
	            (0, _user.shotOffOnlineUser)(data, function (res) {
	                //1  有效 0 禁止
	                console.log("++++++" + res);
	                if (res.ospState == 200) {
	                    _this.setState({ data: res.data.ucUser });
	                    console.log(res);
	    ...
	    (0, _createClass3.default)(online_user, [{
	        ...
	        value: function componentWillMount() {
	            ...
	            (0, _user.getOnlineUserList)(pagination, function (res) {
	                console.log("++++++" + res);
	                if (res.ospState == 200) {
	                    ...
	                    return _this3.state.data.length > 0 ? _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            { title: title_action, onConfirm: function onConfirm() {
	                                    return _this3.deleteLogin(record.jwtToken);
	                                } },
	                            _react2.default.createElement(
	                                'a',
	                                { href: '#' },
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            FormItem,
	                            { label: '\u4F1A\u8BDDID' },
	                            _react2.default.createElement(_input2.default, { value: auser.jwtToken })
	                        ),
	                        _react2.default.createElement(
	                            FormItem,
	                            { label: '\u521B\u5EFA\u65F6\u95F4' },
	                            _react2.default.createElement(_input2.default, { value: auser.createJWTTime })
	                        ),
	                        _react2.default.createElement(
	                            FormItem,
	                            { label: '\u4F1A\u8BDD\u6700\u540E\u6D3B\u52A8\u65F6\u95F4' },
	                            _react2.default.createElement(_input2.default, { value: auser.lastActionTime })
	                        ),
	                        _react2.default.createElement(
	                            FormItem,
	                            { label: '\u8D26\u53F7' },
	                            _react2.default.createElement(_input2.default, { value: auser.userName })
	                        ),
	                        _react2.default.createElement(
	                            FormItem,
	                            { label: 'Email' },
	                            _react2.default.createElement(_input2.default, { value: auser.userEmail })
	                        )
	                    )
	                ),
	                _react2.default.createElement(
	                    _card2.default,
	                    { title: '\u5728\u7EBF\u7528\u6237', className: 'cardStyle' },
	...
	exports.default = online_user;
	
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("D:\\project\\WebstormProjects\\APIStore\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "online_user.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }

/***/ }

});
//# sourceMappingURL=online_user.js.map